                ...
                child: Column(
                  children: [
                    ...
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Text("Vessel Type", style: Get.textTheme.s12w500),
                        Text(controller.vesselList?.vessels
                                ?.expand((e) => e.subVessels ?? [])
                                .firstWhereOrNull((e) =>
                                    e.id == controller.recordVesselType.value)
                                ?.name ??
                            "")
                      ],
                    ),
                    ...
                    if (controller.cocRequirementsSelected.isNotEmpty) ...[
                      8.verticalSpace,
                      Row(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                    ...
                    if (controller.copRequirementsSelected.isNotEmpty) ...[
                      8.verticalSpace,
                      Row(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                    ...
                    if (controller
                        .watchKeepingRequirementsSelected.isNotEmpty) ...[
                      8.verticalSpace,
                      Row(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
              ...
              children: [
                ...
                RichText(
                  ...
                  TextSpan(
                      ...
                      style:
                          Get.textTheme.s12w400.copyWith(color: Colors.black)),
                  TextSpan(
