...
import 'package:join_my_ship/app/modules/boosted_crew_profiles/bindings/boosted_crew_profiles_binding.dart';
import 'package:join_my_ship/app/modules/crew-onboarding/controllers/crew_onboarding_controller.dart';
import 'package:join_my_ship/app/modules/crew_detail/controllers/crew_detail_controller.dart';
                      ...
                      child: StoryView(
                          ...
                          if (((controller.args?.currentIndex ?? 0) + 1) <
                            ...
                            Get.to(
                                ...
                                arguments: BoostedCrewProfilesArguments(
                                    boostedCrewList:
                                        controller.args?.boostedCrewList,
                                    currentIndex:
                        ...
                        storyItems: [
                          StoryItem(
                            ...
                            duration:
                                const Duration(seconds: kDebugMode ? 1 : 15),
                          )
                        ],
                      ),
                    ),
                        ...
                        children: [
                          ...
                          InkWell(
                              onTap: () {
                                Get.back();
                                if (((controller.args?.currentIndex ?? 0) + 1) <
                                    (controller.args?.boostedCrewList?.length ??
                                        0)) {
                                  Get.to(
                                      () => BoostedCrewProfilesView(
                                          tag: controller.args?.currentIndex
