                                                              ...
                                                              UserStates
                                                                  ...
                                                                  ? controller.followingJob
                                                                      ...
                                                                      : TextButton
                                                                          ...
                                                                          onPressed:
                                                                              () {
                                                                            controller.followJob(controller.jobOpenings[index].employerDetails?.id,
                                                                  ...
                                                                  Row(
                                                                    children: [
                                                                      ...
                                                                      Text(controller
                                                                              ...
                                                                              ?.map((e) => e.subVessels ?? [])
                                                                              .expand((e) => e)
                                                                              .firstWhereOrNull((e) => e.id == controller.jobOpenings[index].vesselId)
                                                                              ?.name ??
                                                                          ""),
                                                                    ],
                                                                  ),
                                                          ...
                                                          children: [
                                                            ...
                                                            controller.applyingJob
                                                                ...
                                                                : ElevatedButton(
                                                                    ...
                                                                    onPressed: controller.applications.any((application) => application.jobId == controller.jobOpenings[index].id || application.jobData?.id == controller.jobOpenings[index].id) == true ||
                                                                        ...
                                                                        : () {
                                                                            if (controller.selectedRank.value?.key !=
                                                                                controller.jobOpenings[index].id) {
                                                                              controller.showErrorForJob.value = controller.jobOpenings[index].id;
                                                                              return;
                                                                            }
                                                                            showDialog(
                                                                              context: context,
                                                                    ...
                                                                    child: Text(
                                                                      controller.applications.any((application) => application.jobId == controller.jobOpenings[index].id || application.jobData?.id == controller.jobOpenings[index].id) ==
                                                                              true
                                                                          ? "APPLIED"
                                                                          : "APPLY NOW",
                                                                      style: TextStyle(
