            ...
            children: [
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    Text("Change Currency", style: Get.textTheme.titleMedium),
                    DropdownButtonHideUnderline(
                      child: DropdownButton<CreditCurrency>(
                          ...
                          items: controller.creditsModel?.creditCurrencies
                              ?.map((e) => DropdownMenuItem<CreditCurrency>(
                                  value: e,
                                  ...
                                  children: [
                                    ...
                                    Form(
                                      ...
                                      child: CustomTextFormField(
                                        ...
                                        icon: Text(controller.selectedCurrency
                                                .value?.symbol ??
                                            ""),
                                      ),
                                    ),
                                                                ...
                                                                children: [
                                                                  InkWell(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      margin: index + 1 ==
                                                                              controller
                                                                                  .selectedCurrency.value?.topUps?.length
                                                                          ? EdgeInsets
                                                                              .zero
                                                                      ...
                                                                      decoration: BoxDecoration(
                                                                          color: controller.selectedAmount.value == topUp.amount
                                                                              ? Get.theme.colorScheme.tertiary.withOpacity(
                                                                                  0.05)
                                                                              : null,
                                                                          ...
                                                                          border: Border.all(
                                                                              width: 1,
                                                                              color: controller.selectedAmount.value == topUp.amount ? Get.theme.colorScheme.tertiary : Colors.black)),
                                                                      child:
                                                                          Text(
                                                                        ...
                                                                        style: Get
                                                                            .textTheme
                                                                            .titleMedium
                                                                            ?.copyWith(color: controller.selectedAmount.value == topUp.amount ? Get.theme.colorScheme.tertiary : null),
                                                                      ),
                                                                    ),
                                                                  ),
                                                                  if (topUp
                          ...
                          children: [
                            Row(
                              children: [
                                ...
                                Text(
                                  controller.selectedAmount.value?.removeZeros
                                          .toString() ??
                                      "",
                                  style: Get.textTheme.titleMedium
